...
public class manufacturer_sales_details extends Activity {
	 ProgressDialog pd;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.manufacturer_sales_details); 
...
//	    								android.R.id.text1, values);
	    ...
	    public void commonRequest()
	    {
	        ...
	        HttpPost httppost = new HttpPost("http://"+MainActivity.sip+"/manufacturer_sales_details.php");
	        InputStream is = null;
	        String result = "";
	        try {
	            // Add your data
