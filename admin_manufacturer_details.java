...
public class admin_manufacturer_details extends Activity {
	 ProgressDialog pd;
		  TextView register;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		register.setText("Manufacturer Details");
	...
	public boolean onCreateOptionsMenu(Menu menu) {
	 ...
	 public void commonRequestThread() {
	    ...
	    public void commonRequest()
	    {
	        ...
	        HttpPost httppost = new HttpPost("http://"+MainActivity.sip+"/admin_view_manufacturer.php");
	        InputStream is = null;
	        String result = "";
	        try {
	            // Add your data
...
//		        txtFirstName.setText(""+res);
	        ...
	        try {
	            ...
	            for (int i = 0; i < foo_array.length(); i++) {
	              ...
	              String d="Company : "+js.getString("company_name")
	            		  +"\nManufacturer : "+js.getString("manufacturer_name")
	            		  +"\nDescription : "+js.getString("company_description")
	            		  +"\nContact : "+js.getString("contact")
	            		  +"\nEmail : "+js.getString("email")
	            		  +"\nArea : "+js.getString("area")
	            		  +"\nAddress : "+js.getString("address")
	            		  +"\nISO ID : "+js.getString("iosid")
	            		  ;
