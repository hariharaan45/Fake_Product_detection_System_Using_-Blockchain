...
public class user_track_product extends Activity {
	 Button regbtn ;
...
//	 public static String nam="",fpass="",spass="",cont="",eml="",ran="";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.user_track_product);
	 ...
	 public void commonRequestThread() {
		...
		public void commonRequest()
		{
		    ...
		    HttpPost httppost = new HttpPost("http://"+MainActivity.sip+"/user_track_product.php");
		    InputStream is = null;
		    String result = "";
...
//		        txtFirstName.setText(""+res);
		    ...
		    try {
		        ...
		        for (int i = 0; i < foo_array.length(); i++) {
		            ...
		            String iso_status=js.getString("iso_status");
		         //   String contact=js.getString("contact");
		            if(iso_status.equals("0"))
		            {
		            	iso_status="Fake";	
		            }
		            else if(iso_status.equals("1"))
		            {
		            	iso_status="Original";	
		            }
		...
		public class userlogin extends AsyncTask<String, String, String> {
			        ...
			        protected void onPreExecute() {
			            super.onPreExecute();
			            pDialog = new ProgressDialog(user_track_product.this);
