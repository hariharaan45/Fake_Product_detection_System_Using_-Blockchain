...
public class admin_add_health_inspector extends Activity {
	 Button regbtn ;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.admin_add_health_inspector);
	...
	//  String password=p.getText().toString();
		...
		String	area1=area.getText().toString();
	        ...
	        protected void onPreExecute() {
	            ...
	            super.onPreExecute();
	            pDialog = new ProgressDialog(admin_add_health_inspector.this);
...
ran=tm;
	                String ur = "http://"+MainActivity.sip+"/admin_add_health_inspector.php?"
