...
public class admin_fake_product_alert extends Activity {
	 ProgressDialog pd;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.admin_fake_product_alert); 
...
//	    								android.R.id.text1, values);
	    ...
	    public void commonRequest()
	    {
	        ...
	        HttpPost httppost = new HttpPost("http://"+MainActivity.sip+"/admin_fake_product_alert.php");
	        InputStream is = null;
	        String result = "";
	        try {
	            // Add your data
	            List<NameValuePair> nameValuePairs = new ArrayList<NameValuePair>(2);
	             nameValuePairs.add(new BasicNameValuePair("user",user_login.uemail));
