...
public class retailer_sales extends Activity {
	 ProgressDialog pd;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.user_purchased); 
...
//	    								android.R.id.text1, values);
	    ...
	    public void commonRequest()
	    {
	        ...
	        HttpPost httppost = new HttpPost("http://"+MainActivity.sip+"/retailer_sales_view.php");
	        InputStream is = null;
	        String result = "";
	        try {
	            // Add your data
	            List<NameValuePair> nameValuePairs = new ArrayList<NameValuePair>(2);
	             nameValuePairs.add(new BasicNameValuePair("retailer",retailer_login.uemail));
