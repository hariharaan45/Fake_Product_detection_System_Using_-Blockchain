...
public class retailer_reg extends Activity {
	 Button regbtn ;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.retailer_reg);
	...
	//  String password=p.getText().toString();
		...
		String	area1=area.getText().toString();
	        ...
	        protected void onPreExecute() {
	            ...
	            super.onPreExecute();
	            pDialog = new ProgressDialog(retailer_reg.this);
...
ran=tm;
	                String ur = "http://"+MainActivity.sip+"/retailer_register.php?"
